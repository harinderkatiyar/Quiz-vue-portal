<template>
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md  bg-white" id="sidenav-main">
        <div class="container-fluid">
            ...
            <router-link  style="background-color: #172b4d;" class="navbar-brand" to="/" >
             <img alt="logo placeholder" src="https://mechlintech.com/img/logo-txt.png">
            </router-link>
                        ...
                        <a slot="title" class="nav-link" href="#" role="button">
                            <div class="media align-items-center">
                              <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder" src="https://mechlintech.com/img/logo-digital.png">
                              </span>
                            </div>
                        </a>
...
<script>
  ...
  export default {
    ...
    props: {
      logo: {
        type: String,
        default: 'https://www.mechlintech.com/img/logo-txt.png',
